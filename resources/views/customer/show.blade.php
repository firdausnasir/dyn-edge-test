<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('View Customer') . ': ' . $customer->full_name }}
        </h2>
    </x-slot>
                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                <div>
                                    ...
                                    <input type="text" id="full_name" name="full_name"
                                           ...
                                           placeholder="John" value="{{ old('full_name', $customer?->full_name) }}" disabled>
                                </div>
                                <div>
                                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                                    <input type="email" id="email" name="email"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                           placeholder="Doe" value="{{ old('email', $customer?->email) }}" disabled>
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="ic_no" name="ic_no"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                           placeholder="001230018372" value="{{ old('ic_no', $customer?->ic_no) }}" disabled>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="tel" id="country_id" name="country_id" value="{{ old('phone_no', $customer?->country->name) }}"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                           disabled>
                                </div>
                            </div>
